...
class CurrencyPair {
    constructor(symbol, firstBid, spread, decimalPlaces, longCycle, shortCycle) {
        this.symbol = symbol;
...
function startFxGenerator(cb, ms) {
    setInterval(() => {
...
exports.startFxGenerator = startFxGenerator;
// command line demo:
